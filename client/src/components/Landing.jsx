...
<header className='background'>
  ...
  <h1 className="ml-24 text-white text-6xl tracking-tight font-serif leading-none">Let's <span className='text-turq'> Connect! </span></h1>
  ...
  <p className="p-2">
    <Link className="px-4 py-2 border-2 border-white rounded text-white text-lg hover:bg-red hover:border-black hover:text-black" to="/register">Sign up</Link>
  </p>
  </div>
</header>
</header>
